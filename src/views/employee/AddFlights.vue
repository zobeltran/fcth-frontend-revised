    ...
    <v-flex>
      <v-card class="elevation-12">
        <v-toolbar dark color="primary">
          <v-toolbar-title>Add Flight</v-toolbar-title>
          <v-spacer></v-spacer>
        </v-toolbar>
        <v-card-text>
                ...
                <v-flex xs12 sm6 md3>
                  ...
                  >
                    <v-text-field
                      ...
                      readonly
                    ></v-text-field>
                    <v-time-picker v-if="returnTime" v-model="ReturnTime" actions>
                      <v-spacer></v-spacer>
        ...
        this.$store
          ...
          .then(response => {
            ...
            if (response.status === 201) {
              ...
              this.snackbar.text = "Flight Successfully Added!";
              setTimeout(
